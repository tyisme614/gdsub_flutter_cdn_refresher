...
import 'package:dashboard/layout/image_placeholder.dart';
import 'package:dashboard/layout/text_scale.dart';
import 'package:dashboard/studies/rally/app.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ExcludeSemantics(
                child: SizedBox(
                  ...
                  child: FadeInImagePlaceholder(
                    image:
                        const AssetImage('images/gdsub_logo_transbg.png'),
              ...
              spacing,
              Text(
                'Welcome to GDSub Service Dashboard',
    ...
    return const Padding(
      ...
      child: SizedBox(
        ...
        child: ExcludeSemantics(
          child: FadeInImagePlaceholder(
            image: AssetImage('images/gdsub_logo_transbg.png'),
